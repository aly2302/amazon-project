...
// No global cart variable, always reload from localStorage in renderOrderSummary
                ...
                <div class="cart-item-details-grid">
                    ...
                    <div class="delivery-options">
                        ...
                        ${deliveryOptions.map(deliveryOption => {
                            const optionDate = today.add(deliveryOption.deliveryDays, 'days').format('dddd, MMMM D');
                            const priceString = deliveryOption.priceCents === 0 ? 'FREE' : `$${formatCurrency(deliveryOption.priceCents)} -`;
                            const isChecked = deliveryOption.id === cartItem.deliveryOptionId;
                            return `
                                <div class="delivery-option">
                                    <input type="radio" value="${deliveryOption.id}" ${isChecked ? 'checked' : ''} class="delivery-option-input" name="delivery-option-${matchingProduct.id}">
                                    <div>
                                        <div class="delivery-option-date">${optionDate}</div>
